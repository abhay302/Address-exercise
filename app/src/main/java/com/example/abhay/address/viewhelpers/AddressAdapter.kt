...
import com.example.abhay.address.controllers.display.DisplayAddressFragment
 ...
 */
class AddressAdapter(private val list: MutableList<Address>, private val fragment: DisplayAddressFragment) : RecyclerView.Adapter<AddressAdapter.AddressHolder>() {
